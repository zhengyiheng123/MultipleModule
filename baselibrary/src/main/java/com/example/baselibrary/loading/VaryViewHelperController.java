 ...
 */
package com.example.baselibrary.loading;
...
public class VaryViewHelperController {
    ...
    public void showNetworkError(View.OnClickListener onClickListener) {
        ...
        imageView.setImageResource(R.drawable.ic_error_net);

        View clickView = layout.findViewById(R.id.clickRefresh);
    ...
    public void showEmpty(String emptyMsg, int imgId, String btnMsg, View.OnClickListener onClickListener) {
        View layout = helper.inflate(R.layout.message);
        TextView textView = (TextView) layout.findViewById(R.id.message_info);
        ...
        TextView btntextView = (TextView) layout.findViewById(R.id.clickRefresh);

        if (!TextUtils.isEmpty(btnMsg)) {
            btntextView.setVisibility(View.VISIBLE);
            btntextView.setText(btnMsg);
            if (onClickListener != null) {
                btntextView.setOnClickListener(onClickListener);
            }
        }
